...
var model = {
    boardSize: 7,
    numShips: 3,
    shipLength: 1,//can be changed to 3 if you want so that the ships'length takes 3 cells
    shipsSunk: 0,
    //game's parameters
	...
	ships: [
		...
		{ locations: [0], hits: [""] },
		{ locations: [0], hits: [""] }
	],//if you change the shipLength to 3 you also have to make the locations and the hits as so: locations: [0,0,0], hits ["","","",]
